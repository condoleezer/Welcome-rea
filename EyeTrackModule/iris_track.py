...
def map_coordinates_to_screen(iris_centroid, screen_size):
    ...
    screen_width, screen_height = screen_size if screen_size else (1280, 748)
...
def project_gaze_to_screen(eye_center, gaze_vector):
    ...
    scaling_factor = 500 * (0.5 + distance)  # Ajuster la formule selon les besoins
...
screen_height = 748  # Default height
    ...
    try:
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                gaze_point_left_x, gaze_point_left_y = project_gaze_to_screen(left_eye_center, gaze_left)
                gaze_point_right_x, gaze_point_right_y = project_gaze_to_screen(right_eye_center, gaze_right)
